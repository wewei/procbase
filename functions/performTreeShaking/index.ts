...
import type { TreeShakingOptions } from '@t/tree-shaking/TreeShakingOptions';
import type { ProjectAnalysisResult } from '@t/analysis/ProjectAnalysisResult';
import calculateClosure from '@f/createProjectSymbolTable/calculateClosure';
import findUnusedSymbols from '@f/createProjectSymbolTable/findUnusedSymbols';
